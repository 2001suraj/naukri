...
final _formKey = GlobalKey<FormState>();
 userLogin()async{
  ...
  String res = await AuthServices().loginUser(email: emailController.text, password: passwordController.text);
  Navigator.push(context, MaterialPageRoute(builder: (context)=>AHomeScreen()));
    setState(() {
     isloading = true;
   });
 }
            ...
            child: Column(
              ...
              children: [
                ...
                MaterialButton(
                  ...
                  onPressed:userLogin,
                  child: isloading ?Text('Login'): Center(child: CircularProgressIndicator(color:Colors.white)),
                ),
                SizedBox(
                  height: 40,
                ),
